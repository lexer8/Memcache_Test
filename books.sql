...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 19 2016 г., 06:11
...
INSERT INTO `books` (`id`, `author`, `title`, `year`, `page_count`, `price`, `created`, `status`) VALUES
(1, 'Robin Nixon', 'Learning PHP, MySQL, JavaScript and CSS', 2013, 560, 337.72, '2016-02-18 00:28:00', 1),
(2, 'Luke Welling, Laura Thomson', 'PHP and MySQL Web Development', 2010, 834, 330, '2016-02-18 01:00:00', 1),
(3, 'Matt Zandstra', 'PHP Objects, Patterns and Practice', 2011, 528, 1192.24, '2016-02-18 01:02:00', 1),
(4, 'Bear Bibeault, Yehuda Katz', 'jQuery in Action', 2009, 373, 930, '2016-02-18 00:05:00', 1);
